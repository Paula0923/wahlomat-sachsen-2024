...
a) Mittelwerte auf beiden Achsen (Parteien alphabetisch geordnet, alle Werte auf zwei Nachkommastellen gerundet)
| Partei    | X | Y     |
|:---------|:-------:|:----------:|
| AfD    | 0.07    |  -0.65  |
| BSW     | -0.2    | 0.04  |
...
- Operationalisierung:
    1. Sämtliche Thesen wurden jeweils einer Achse zugeordnet (X: links-rechts (wirtschaftlich), Y: konservativ-progressiv (gesellschaftlich)),
